...
0. `notebooks/00_merge_TRIPOD_references.ipynb`: 
...
1. `notebooks/01_gather_full_text.ipynb`:
...
2a. `notebooks/02a_create_paper_assessment_annotations.ipynb`:
...
2b. `notebooks/02b_evaluate_paper_assessment_prompt.ipynb`:
...
2c. `notebooks/02c_generate_paper_assessment_predictions.ipynb`: 
...
3a. `notebooks/03a_create_repo_assessment_annotations.ipynb`:
...
3b. `notebooks/03b_evaluate_repo_assessment_prompt.ipynb`:
